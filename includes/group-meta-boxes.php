...
function add_group_meta_box() { 
	...
	?>
	<fieldset><legend class="screen-reader-text"><span><?php _e('Core Group Options') ?></span></legend>
	...
	<?php _e('Group Description'); ?>
	<input id="group_desc" type="text" name="group_desc" value="" />
	</label></p>
	</fieldset>
	<fieldset><legend class="screen-reader-text"><span><?php _e('Advanced Group Options') ?></span></legend>
	...
	<fieldset><legend class="screen-reader-text"><span><?php _e('Group Hierarchy Options') ?></span></legend>
		...
		<?php else: ?>
		<p><?php _e('Your version of BuddyPress Group Hierarchy is too old to use with the organizer. Please upgrade to version <code>1.2.1</code> or higher.'); ?></p>
		<?php endif; ?>
	</fieldset>
	<?php endif; ?>
	<?php do_action( 'bp_group_organizer_display_new_group_options' ); ?>
	<p><?php _e('Create a group to add to your site.'); ?></p>
...
add_meta_box('add_group_meta_box', 'Create a Group', 'add_group_meta_box', 'group-organizer', 'side');
